...
const Sidebar = () => {
  ...
  return (
    <div className={`${isOpen ? 'right-0' : '-right-full'} w-full bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] xl:max-w-[30vw] transition-all durtion-300 z-20 px-4 lg:px-[35px]`}>
      ...
      <div className=' flex w-full justify-between items-center'>
        ...
        className='cursor-pointer py-4 bg-red-500 text-white w-12 h-12 flex justify-center items-center text-x1'>
          ...
          <Link to='/' className='bg-pink-200 flex p-4 justify-center items-center text-white w-full font-medium'>Checkout</Link>
      </div>
    </div>
  );
};
